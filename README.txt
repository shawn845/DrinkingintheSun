...
Landing page update:
- Added real app screenshots to the landing page under /public/screenshots/
- Files: list-view.webp, map-view.webp, detail-view.webp


Landing page simplified: hero, brief how-it-works section, real screenshots for list/map/pub view, and iPhone install steps.
